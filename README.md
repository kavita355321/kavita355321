...
| Project | What I delivered | Tools |
|---|---|---|
| [StudentSettle London](https://venerable-faun-9f3991.netlify.app/) | Built and deployed an AI-assisted decision-support platform that helps international students compare accommodation, travel and living costs. Implemented REST APIs, JWT authentication, PostgreSQL persistence and 83 automated backend tests. | React, FastAPI, PostgreSQL, SQLAlchemy, Python |
| [Public Health Data Analysis](https://github.com/kavita355321/Public-Health-Data-Analysis) | Combined World Bank and Our World in Data datasets to examine health-spending and vaccination inequalities, create an equity score and forecast vaccination trends. | Python, Pandas, scikit-learn, Statsmodels |
| Blinkit Sales & BI Case Study | Analysed sales, customer ratings and outlet performance across [SQL](https://github.com/kavita355321/blinkit-sql-analysis), [Python](https://github.com/kavita355321/blinkit-python-analysis) and [Power BI](https://github.com/kavita355321/blinkit-powerbi-dashboard), translating KPIs into actionable business insights. | SQL, Python, Power BI, Excel |
...
| Area | Skills |
|---|---|
| Data analysis | SQL, Python, Pandas, NumPy, Excel, exploratory data analysis, data cleaning |
| BI & visualisation | Power BI, Tableau, Matplotlib, Seaborn, KPI reporting, data storytelling |
| Statistics & ML | Statistical analysis, regression, classification, clustering, time-series forecasting, scikit-learn, Statsmodels |
| Data & backend | PostgreSQL, MySQL, SQLite, FastAPI, Flask, SQLAlchemy, REST APIs, ETL/ELT concepts |
| Engineering | Git, GitHub, testing, React, JavaScript, HTML, CSS |
